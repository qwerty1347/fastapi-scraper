...
from app.services.scraper.base import ScraperBase


ENT_NEWS_URL= "https://m.entertain.naver.com/ranking"


class EntNewsScrapService(ScraperBase):
    def __init__(self, playwright_manager: PlaywrightManager, page: Page | None = None):
    ...
    async def do_scraping(self) -> list[EntertainmentArticle]:
        try:
            await self.open_scraping_page(ENT_NEWS_URL)
            print("* 아티클 스크래핑")

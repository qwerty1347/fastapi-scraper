...
class NewsSummarizeService:
    ...
    async def summarize_one(self, article: str, system_prompt: str):
    ...
    async def summarize_many(self, articles: list[NewsArticle], system_prompt: str) -> list[SummarizedArticle]:
        ...
        for item in articles:
            summarized_articles.append(await self.summarize_one(item.article, system_prompt))
        ...
        return [SummarizedArticle.model_validate(item) for item in summarized_articles]